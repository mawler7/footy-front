...
const renderStatRow = (statKey, homeValue, awayValue, maxValue) => {
    ...
    return (
        <StatRow key={statKey}>
            ...
            <ProgressBar>
                <div style={{ width: `${homeWidth}%`, backgroundColor: '#4caf50', height: '100%', position: 'absolute', left: 0 }} />
                <div style={{ width: `${awayWidth}%`, backgroundColor: '#f44336', height: '100%', position: 'absolute', right: 0 }} />
            </ProgressBar>
            <Values>
